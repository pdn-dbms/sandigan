...
class BarangayOfficals extends StatefulWidget {
  final Municipality municipality;
  final String barangay;

  BarangayOfficals({required this.municipality, required this.barangay});
  @override
  _BarangayOfficalsState createState() => _BarangayOfficalsState();
}

class _BarangayOfficalsState extends State<BarangayOfficals> {
  @override
        ...
        builder:
          ...
          snapshot.data!.docs.forEach((doc) {
            ...
            officials.add({
              ...
              'order': data['position'] == 'Captain'
                  ? 1
                  : data['position'] == 'Kagawad'
                      ? 2
                      : 3
            });
